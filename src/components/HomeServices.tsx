...
export default function HomeServices() {
    ...
    return (
        <section id='services' className="relative w-full bg-white pb-32">
            {!content ? (
                ...
                <>
                    <div className="container">
                        <div className="relative bg-black rounded-[40px] py-24 md:py-32 overflow-hidden">
                    ...
                    <div className="container -mt-24 md:-mt-32 relative z-20 top-20">
                        <div className="grid grid-cols-1 md:grid-cols-3">
                            {[
                                ...
                                <div key={idx} className="p-2 flex flex-col h-full group transition-transform duration-300">
                                    ...
                                    <div className="flex flex-col grow">
                                        <h3 className="text-2xl font-bold mb-2 text-black group-hover:text-gray-700 transition-colors line-clamp-3">
                                            {service.title} {idx == 2 && <span className='text-white'>for asethetic</span>}
                                        </h3>
