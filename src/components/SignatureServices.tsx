            ...
            <div className="relative h-[800px] md:h-[600px] w-full rounded-[40px] overflow-hidden group">
                ...
                <div className="absolute inset-0 grid grid-cols-1 md:grid-cols-3">
                    ...
                    <div className="md:col-span-2 flex flex-col">
                        {/* Top: Title & Intro */}
                        <AnimateOnScroll animation="fade-in-up" className="p-8 md:p-16 grow border-b border-white/10 md:border-b-0 md:border-r">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 shrink-0 border-t border-white/10">
