export const MOCK_DATA = {
    ...
    // 2. Brands
    brands: [
        { id: '1', name: 'Lamborghini', isActive: true },
        { id: '2', name: 'Ferrari', isActive: true },
        { id: '3', name: 'Rolls Royce', isActive: true },
        { id: '4', name: 'Mercedes', isActive: true },
        { id: '5', name: 'Porsche', isActive: true },
        { id: '6', name: 'McLaren', isActive: true },
        { id: '7', name: 'Bentley', isActive: true }
    ],
    ...
    vehicles: [
        // Lamborghini
        {
            id: 'lamborghini-urus-performante', brand: 'Lamborghini', model: 'Urus Performante', year: 2024, bodyType: 'SUV', fuelType: 'Petrol', transmission: 'Automatic', seats: 5, doors: 4, kmPerDay: 250,
            ...
            images: [{ url: 'https://images.unsplash.com/photo-1662998399321-72983177813a?auto=format&fit=crop&w=800', isPrimary: true }]
        },
        {
            id: 'lamborghini-huracan-evo', brand: 'Lamborghini', model: 'Huracan EVO', year: 2023, bodyType: 'Coupe', fuelType: 'Petrol', transmission: 'Automatic', seats: 2, doors: 2, kmPerDay: 200,
            pricePerDay: 5499, currency: 'AED', isActive: true,
            description: "Experience the ultimate in luxury and performance with this premium vehicle. Whether for a special occasion or a weekend getaway, this car offers unmatched comfort and style.",
            images: [{ url: 'https://images.unsplash.com/photo-1594950130617-64b58ab263c9?auto=format&fit=crop&w=800', isPrimary: true }]
        },
        {
            id: 'lamborghini-aventador-svj', brand: 'Lamborghini', model: 'Aventador SVJ', year: 2023, bodyType: 'Coupe', fuelType: 'Petrol', transmission: 'Automatic', seats: 2, doors: 2, kmPerDay: 200,
            pricePerDay: 7999, currency: 'AED', isActive: true,
            description: "Experience the ultimate in luxury and performance with this premium vehicle. Whether for a special occasion or a weekend getaway, this car offers unmatched comfort and style.",
            images: [{ url: 'https://images.unsplash.com/photo-1544636331-e26879cd4d9b?auto=format&fit=crop&w=800', isPrimary: true }]
        },
