    ...
    const services = [
        {
            ...
            image: content.rental?.image || 'https://images.unsplash.com/photo-1503376763036-066120622c74?auto=format&fit=crop&w=800&q=80',
        ...
        },
        {
            ...
            image: content.chauffeur?.image || 'https://images.unsplash.com/photo-1544636331-e26879cd4d9b?auto=format&fit=crop&w=800&q=80',
        ...
        },
        {
            ...
            image: content.vip?.image || 'https://images.unsplash.com/photo-1631295868223-632658513171?auto=format&fit=crop&w=800&q=80',
            link: '/services#vip'
        }
    ]
            ...
            <div className="container mx-auto px-6 -mt-24 md:-mt-32 relative z-20 top-20">
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                    {services.map((service, idx) => (
                        <div key={idx} className="rounded-[30px] p-4 flex flex-col h-full group transition-transform duration-300 hover:-translate-y-2">
